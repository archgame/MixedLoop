...
Shader "bush_b"
{
	Properties
	{
		...
		[ASEBegin]_bush_b_d("bush_b_d", 2D) = "white" {}
		[ASEEnd]_bush_b_n("bush_b_n", 2D) = "bump" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_bush_b_d = IN.ase_texcoord7.xy * _bush_b_d_ST.xy + _bush_b_d_ST.zw;
				float4 tex2DNode1 = tex2D( _bush_b_d, uv_bush_b_d );
				
				float2 uv_bush_b_n = IN.ase_texcoord7.xy * _bush_b_n_ST.xy + _bush_b_n_ST.zw;
				
				float3 Albedo = tex2DNode1.rgb;
				float3 Normal = UnpackNormalScale( tex2D( _bush_b_n, uv_bush_b_n ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_bush_b_d = IN.ase_texcoord2.xy * _bush_b_d_ST.xy + _bush_b_d_ST.zw;
				float4 tex2DNode1 = tex2D( _bush_b_d, uv_bush_b_d );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_bush_b_d = IN.ase_texcoord3.xy * _bush_b_d_ST.xy + _bush_b_d_ST.zw;
				float4 tex2DNode1 = tex2D( _bush_b_d, uv_bush_b_d );
...
/*ASEBEGIN
Version=18900
7;6;1906;1013;946;267;1;True;False
Node;AmplifyShaderEditor.SamplerNode;1;-431,-99;Inherit;True;Property;_bush_b_d;bush_b_d;0;0;Create;True;0;0;0;False;0;False;-1;5c2ad8628737d7f4598775c697283634;5c2ad8628737d7f4598775c697283634;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-443,145;Inherit;True;Property;_bush_b_n;bush_b_n;1;0;Create;True;0;0;0;False;0;False;-1;1013db50abe567249a8ebe23eb3190f6;1013db50abe567249a8ebe23eb3190f6;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C8B8077DAB3FF81C383D2E46DF60127D831CD9D5