...
Shader "leave_palm"
{
	Properties
	{
		...
		[ASEBegin]_palm_date_a_Color_Color("palm_date_a_Color_Color", 2D) = "white" {}
		[ASEEnd]_palm_date_a_Color_Normal("palm_date_a_Color_Normal", 2D) = "bump" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _palm_date_a_Color_Color_ST;
			float4 _palm_date_a_Color_Normal_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _palm_date_a_Color_Color;
			sampler2D _palm_date_a_Color_Normal;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_palm_date_a_Color_Color = IN.ase_texcoord7.xy * _palm_date_a_Color_Color_ST.xy + _palm_date_a_Color_Color_ST.zw;
				float4 tex2DNode1 = tex2D( _palm_date_a_Color_Color, uv_palm_date_a_Color_Color );
				
				float2 uv_palm_date_a_Color_Normal = IN.ase_texcoord7.xy * _palm_date_a_Color_Normal_ST.xy + _palm_date_a_Color_Normal_ST.zw;
				
				float3 Albedo = tex2DNode1.rgb;
				float3 Normal = UnpackNormalScale( tex2D( _palm_date_a_Color_Normal, uv_palm_date_a_Color_Normal ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = tex2DNode1.r;
				float Occlusion = 1;
				...
				float3 Translucency = tex2DNode1.rgb;
				#ifdef ASE_DEPTH_WRITE_ON
				float DepthValue = 0;
				#endif
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_palm_date_a_Color_Color = IN.ase_texcoord2.xy * _palm_date_a_Color_Color_ST.xy + _palm_date_a_Color_Color_ST.zw;
				float4 tex2DNode1 = tex2D( _palm_date_a_Color_Color, uv_palm_date_a_Color_Color );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_palm_date_a_Color_Color = IN.ase_texcoord3.xy * _palm_date_a_Color_Color_ST.xy + _palm_date_a_Color_Color_ST.zw;
				float4 tex2DNode1 = tex2D( _palm_date_a_Color_Color, uv_palm_date_a_Color_Color );
...
/*ASEBEGIN
Version=18900
7;6;1906;1013;964.9634;610.9712;1;True;False
Node;AmplifyShaderEditor.SamplerNode;2;-411,-83.5;Inherit;True;Property;_palm_date_a_Color_Normal;palm_date_a_Color_Normal;1;0;Create;True;0;0;0;False;0;False;-1;1d9e8b3fb411bf948a9177bd7b21e72b;1d9e8b3fb411bf948a9177bd7b21e72b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-508,-342.5;Inherit;True;Property;_palm_date_a_Color_Color;palm_date_a_Color_Color;0;0;Create;True;0;0;0;False;0;False;-1;211c022a6e1532c41aaec81c4212c266;211c022a6e1532c41aaec81c4212c266;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
